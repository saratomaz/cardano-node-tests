...
def create_db_tables():
    ...
    testnet_table = """ CREATE TABLE IF NOT EXISTS testnet (
                                        ...
                                        platform_version text NOT NULL,
                                        chain_size_bytes text NOT NULL,
                                        byron_start_time text NOT NULL,
                                        byron_start_epoch integer NOT NULL,
                                        byron_slots_in_era integer NOT NULL,
                                        byron_start_sync_time text NOT NULL,
                                        byron_end_sync_time text NOT NULL,
                                        byron_sync_duration_secs integer NOT NULL,
                                        byron_sync_speed_sps integer NOT NULL,
                                        shelley_start_time text NOT NULL,
                                        shelley_start_epoch integer NOT NULL,
                                        shelley_slots_in_era integer NOT NULL,
                                        shelley_start_sync_time text NOT NULL,
                                        shelley_end_sync_time text NOT NULL,
                                        shelley_sync_duration_secs integer NOT NULL,
                                        shelley_sync_speed_sps integer NOT NULL,
                                        allegra_start_time text NOT NULL,
                                        allegra_start_epoch integer NOT NULL,
                                        allegra_slots_in_era integer NOT NULL,
                                        allegra_start_sync_time text NOT NULL,
                                        allegra_end_sync_time text NOT NULL,
                                        allegra_sync_duration_secs integer NOT NULL,
                                        allegra_sync_speed_sps integer NOT NULL,
                                        mary_start_time text NOT NULL,
                                        mary_start_epoch integer NOT NULL,
                                        mary_slots_in_era integer NOT NULL,
                                        mary_start_sync_time text NOT NULL,
                                        mary_end_sync_time text NOT NULL,
                                        mary_sync_duration_secs integer NOT NULL,
                                        mary_sync_speed_sps integer NOT NULL,
                                        sync_duration_per_epoch text NOT NULL
                                    ); """
